logo = """
_       _    __   _   _  _______    ___  ___       _   _  ___      __   _     _     ___    _   _  _____  _____    __   ___   
( )  _  ( ) /'_ `\( ) ( )(_____  ) /'_  )(  _`\    ( ) ( )(  _`\  /'_ `\( )   ( )   (  _`\ ( ) ( )(___  )(___  ) /'_ `\|  _`\ 
| | ( ) | |( (_) || `\| |     /'/'(_)_) || | ) |   | | | || | ) |( (_) |`\`\_/'/'   | ( (_)| | | |    | |    | |( (_) || (_) )
| | | | | | \__, || , ` |   /'/'   _(_ < | | | )   | | | || | | ) \__, |  `\ /'     | |___ | | | | _  | | _  | | \__, || ,  / 
| (_/ \_) |    | || |`\ | /'/'    ( )_) || |_) |   | (_) || |_) |    | |   | |      | (_, )| (_) |( )_| |( )_| |    | || |\ \ 
`\___x___/'    (_)(_) (_)(_/      `\____)(____/'   (_____)(____/'    (_)   (_)      (____/'(_____)`\___/'`\___/'    (_)(_) (_)
"""
print(logo)
...
""")
            ...
            print(f"\033[38;5;25m[+] AAPKA MESSAGE J4Y X V33RU KI TARAF SE SEND KIYA GYA HAI => Thread ID: {thread_id} => Token: {token_names[access_tokens.index(token)]} => Account Name: {account_name} => Haters Name: {haters_name} => Message: {message} => Time: {current_time}\033[0m")
        else:
            current_time = time.strftime("%H:%M:%S")
            print(f"""
 \033[31;5;196m 
